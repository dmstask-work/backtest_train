"""
Modul Laporan Performa Backtesting (Fase 5 - Output).

Menghitung semua metrik performa dari hasil simulasi dan mencetak
laporan dalam dua format:
  1. Teks terstruktur yang mudah dibaca di terminal (AionUi / VPS log)
...
Metrik yang Dihitung:
  ...
  ─ Risiko            : Maximum Drawdown (%)
  ─ Per strategi      : Trades, Win Rate, PnL untuk Trend-Following vs Mean-Reversion
